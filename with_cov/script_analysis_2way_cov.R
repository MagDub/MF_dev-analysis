...
# From example: https://www.datanovia.com/en/lessons/repeated-measures-anova-in-r/
  ...
  dataMFdev <- read_excel("~/GoogleDrive/UCL/MFdev/excels/data_thompson_mod12_final.xlsx")  
  ...
  # Pairwise comparisons
  pwcD <- data_tmp %>%
    pairwise_t_test(freq ~ ageGroup, paired = FALSE, pool.sd = FALSE, p.adjust.method = "none")
